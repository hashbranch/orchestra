defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    ...
    agent_runtime_selection = Keyword.get(config, :agent_runtime_selection)
    agent_runtimes = Keyword.get(config, :agent_runtimes)
    ...
    sections =
      [
        ...
        agent_runtime_selection && "  runtime_selection: #{yaml_value(agent_runtime_selection)}",
        agent_runtimes && "  runtimes: #{yaml_value(agent_runtimes)}",
        "codex:",
