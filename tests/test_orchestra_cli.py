...
class OrchestraCliTests(unittest.TestCase):
    def test_init_writes_config_and_workflow(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(config["linear_project_slug"], "symphony-test")
            ...
            self.assertIn("orchestra pr-feedback wait --wait-seconds 300 --poll-seconds 15", workflow)
    ...
    def test_install_symphony_skip_build_clones_local_source(self):
        with tempfile.TemporaryDirectory() as tmp:
